...
class FloatingBubbleService : Service() {
    ...
    private fun createBubbleView() {
        // React Native বাবলের মতো দেখতে নেটিভ বাবল তৈরি করুন
        ...
        bubbleView?.setOnTouchListener { _, event ->
            when (event.action) {
                ...
                MotionEvent.ACTION_UP -> {
                    if (!isDragging) {
                        // 🔥 গুরুত্বপূর্ণ: ক্লিক করলে MainActivity খুলবে (React Native UI)
                        val intent = Intent(this, MainActivity::class.java)
                        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                        intent.putExtra("openFromBubble", true) // বিকল্প: bubble থেকে খোলা হয়েছে বলে জানান
